...
<?php /* ----- Anonymous checkbox ----- */ ?>
							<td style="width: 27%;"><input type="hidden" name="anonymous" value="1" onclick="do_anonymous(form);" type="checkbox" />&nbsp; <?php //echo __("Anonymous"); ?></td>
						</tr>
<?php //$password = "issuu"; $ftpserver = "10.0.0.100"; //$ftpserverport = "21";/* ----- Password ----- */ ?>
						<tr style="vertical-align: middle;"> 
...
<?php /* ----- Passive mode ----- */ ?>
							<td><span><input type="hidden" name="passivemode" value="yes" type="checkbox" <?php echo $passivemode["checked"]; ?> />&nbsp; <?php // echo __("Passive mode"); ?></span></td>
						</tr>
<?php $directory = "" /* ----- Initial directory ----- */ ?>
						<tr style="vertical-align: middle;"> 
							<td style="padding-<?php echo __("left"); ?>: 10px;"><?php // echo __("Initial directory"); ?></td>
							<td><input type="hidden" name="directory" value="<?php // echo $directory; ?>" type="text" style="width:230px;" /></td>     

<?php /* ----- SSL ----- */ ?>
							<td><?php  $sslconnect["checked"] = true;$sslconnect="yes"; ?></td>
							<!-- <td></td> -->
						</tr>
...
<?php /* ----- Language ----- */ ?>
						<tr style="vertical-align: middle;"> 
							...
							<td>
<?php						// printLanguageSelect("language", $language_onchange, "width:120px;", "input_select"); ?> 							</td>
							<td></td>
						</tr>
<?php /* ----- Skin ----- */ ?>
						<tr style="vertical-align: middle;"> 
...
<?php /* ----- FTP mode radio button ----- */ ?>
						<tr style="vertical-align: middle;"> 
							...
							<td colspan="2"> 
                                                            	<input type ="hidden" name="ftpmode" value="binary"    <?php echo $ftpmode["binary"]; ?>    type="radio" />&nbsp;<!--Binary--> &nbsp; &nbsp;
								<input type="hidden" name="ftpmode" value="automatic" <?php echo $ftpmode["automatic"]; ?> type="radio" />&nbsp; <?php // echo __("Automatic"); ?> 
							</td>
						</tr>
<?php /* ----- Login button ----- */ ?>
						<tr>
							...
							<td colspan="2" style="padding-<?php echo __("left"); ?>: 40px;"> 
								<input type="submit" class="button" name="Login" onclick="return validateForm(this)"  value="<?php echo __("Login"); ?>" alt="<?php echo __("Login"); ?>" /> 
							</td>
						</tr>
