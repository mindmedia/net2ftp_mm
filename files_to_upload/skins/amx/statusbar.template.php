...
<!-- Template /skins/amx/statusbar.template.php begin -->
...
<?php require_once($net2ftp_globals["application_skinsdir"] . "/" . $net2ftp_globals["skin"] . "/status/status.template.php"); ?> 
	<div id="head">
		<div id="headleft">
			<!-- <a href="http://www.net2ftp.com" target="_blank">--> <?php echo printPngImage($net2ftp_globals["image_url"] . "/img/logo2.png", "net2ftp", "border: 0;"); ?><!-- </a> -->
		</div>
		<div style="float: <?php echo __("right"); ?>; text-align: <?php echo __("right"); ?>;">
			<form id="StatusbarForm" method="post" action="<?php echo $net2ftp_globals["action_url"]; ?>"><br/><br/>
...
<!-- Template /skins/amx/statusbar.template.php end -->
